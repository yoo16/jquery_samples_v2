$(function () {
    ...
    function finishInlineEdit(li, input, text, save) {
        // TODO: インライン入力値の取得
        const nextValue = input.val().trim() || "new memo";
        // 値があればテキストを置き換える
        if (save && nextValue) {
            text.text(nextValue);
        }
    ...
    function getInputValue() {
        // TODO: input#input-text の値を取得、テキストがなければ new memo
    ...
    $("#btn-append").on("click", function () {
        ...
        // TODO: id="item-list" の末尾に追加: append()
    ...
    $("#btn-prepend").on("click", function () {
        const element = newItem();
        // TODO: id="item-list" の先頭に追加: prepend()
